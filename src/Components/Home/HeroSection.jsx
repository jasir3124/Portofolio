    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center px-4 md:px-8 lg:px-16 gap-8 lg:gap-0">
                <div className="flex flex-col items-center lg:items-start justify-self-center lg:justify-self-end w-full lg:w-3/4 space-y-3 text-center lg:text-left mb-20">
                    <h1 className="text-maroon text-4xl md:text-5xl lg:text-6xl font-extralight"
                        style={{ fontFamily: 'Japanenglish' }}>Jasir Limani a <br /> Software Engineer</h1>
                    <p className="text-xl md:text-2xl font-sans">I'm a software engineer specializing in web and mobile app
                        development, building scalable and efficient solutions.</p>
                    <Link to="/contact" className="text-lg md:text-xl font-sans bg-gold text-white px-4 py-2 mt-4 tracking-widest hover:bg-gold/90 transition-colors"
                        style={{ fontFamily: 'Japanenglish' }}>Contact</Link>
                </div>
                <div className="flex items-center justify-center">
                    <div className="relative -z-10">
                        <img className="h-[400px] md:h-[500px] lg:h-[700px] object-contain" src={Me} alt="Profile" />
            ...
            <div className='flex justify-center items-center mt-14 md:mt-16 lg:mt-28 relative'>
