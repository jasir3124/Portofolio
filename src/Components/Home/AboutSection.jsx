  ...
  return (
    <section className="px-6 sm:px-10 lg:px-20 py-16">
      ...
      <div className="flex items-center gap-4 lg:mb-0 mb-10">
        <h1 className="text-5xl font-Japanenglish text-maroon">About Me</h1>
        <div className="flex-1 h-0.5 bg-gold max-w-[120px]" />
      </div>
        ...
        <div className="flex justify-center">
          <div className="relative h-[450px] md:h-[450px] lg:h-[550px] w-[260px] md:w-[360px] lg:w-[450px] ">
            <Image
              ...
              priority
            />
            <div className="absolute bottom-[-45px] left-1/2 -translate-x-1/2 w-full h-24 bg-white/100 blur-xl rounded-full z-10" />
          </div>
        </div>
      </div>
    </section>
