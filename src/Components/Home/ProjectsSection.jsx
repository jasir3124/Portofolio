    ...
    return (
        <div>
            <div className='flex items-center gap-2 sm:gap-3 md:gap-4 mb-7 md:mb-10 ms-10'>
                ...
                <Link to="/projects" className='ms-2 sm:ms-4 md:ms-7 text-lg sm:text-xl md:text-2xl font-bold font-Japanenglish text-maroon flex items-center gap-2 sm:gap-3 md:gap-4 whitespace-nowrap'>View All <CgArrowLongRight /></Link>
            </div>
