...
const ProjectsCard = (props) => {
    const { index = 0, inView = false } = props;

    // Determine animation props based on inView
        ...
        >
            ...
            <div className='grid sm:flex justify-between gap-2'>
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center text-sm font-bold bg-black text-white px-3 py-1 rounded-full shadow hover:bg-[#FFB22C] hover:text-black transition"
                >
                    Open on Github     
